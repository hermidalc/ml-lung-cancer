...
for (i in 1:length(eset_tr_strs)) {
    ...
    eset_tr_cbt_params_str <- paste0(eset_tr_cbt_str, "_params")
    assign(eset_tr_cbt_params_str, cbt_params)
    save(list=eset_tr_cbt_params_str, file=paste0("data/", eset_tr_cbt_params_str, ".Rda"))
