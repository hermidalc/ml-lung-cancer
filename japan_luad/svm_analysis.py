...
r_filter_eset_fs = robjects.globalenv["filterEsetFs"]
...
for i in range(0, 1):
    ...
    eset_fs = r_filter_eset_fs(eset, relapse_sample_nums[:num_fs_relapse_samples], norelapse_sample_nums[:num_fs_norelapse_samples])
